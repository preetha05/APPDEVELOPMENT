...
const getCourse = () => axios.get(`${URI}/course/get`)
const getCoursebyId = (id) => axios.get(`${URI}/course/find/${id}`, { headers })
const addCourse = (course) => axios.post(`${URI}/course/add`, course, { headers })
const editCourse = (id, course) => axios.put(`${URI}/course/edit/${id}`, course, { headers })
const deleteCourse = (id) => axios.delete(`${URI}/course/delete/${id}`, { headers })
...
export { getProduct, getProductbyId, addProduct, editProduct, deleteProduct, getProductCount,getCourse,getCoursebyId,editCourse,addCourse,deleteCourse, getFeedback, addFeedback, deleteFeedback, getFeedbacktCount, getUser, getUserbyId, editUser, deleteUser, getUserCount, userLogin,userRegister,addOrder,getUserOrders,getOrderCount }
